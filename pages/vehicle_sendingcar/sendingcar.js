...
Page({
        ...
        success: function (res) {
          ...
          if (result == "[]") {
            ...
            for (var i = 0; i < resultArray.length; i++) {
              ...
              driverName.push(jsonData.DRIVERNAME);
            }
            that.setData({
              drivers: driverName,
              driverIndex: 0
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          if (result == "[]") {
            // wx.showModal({
            //   title: '提示',
            //   content: '没有' + Suplier + '公司对应的车号数据',
            // })
            that.setData({
              isTrucksEmpty: '没有车号数据',
            })
          }else{
            result = result + '';
            result = result.replace('[', '');
  ...
  submit:function(){
    ...
    var Trailer = {
      ...
      TRUCKNO: this.data.trucks[this.data.truckIndex],
      DRIVER: this.data.drivers[this.data.driverIndex],
